...
# -*- coding: utf-8 -*-
#
# slurp documentation build configuration file, created by
# sphinx-quickstart.
#
...
author = 'Julien BLOND <julien.blond@bertin.fr>'
...
latex_documents = [
    (master_doc, 'slurp.tex', 'slurp Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'slurp', 'slurp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'slurp', 'slurp Documentation',
     author, 'slurp', 'One line description of project.',
     'Miscellaneous'),
]
